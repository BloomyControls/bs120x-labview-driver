...
This package provides an API for controlling the Bloomy BS1200 and BS1201 cell simulators in LabVIEW.  The API exposes nearly all of the capabilities of the cell simulators including execution control via ethernet or CAN, and configuration via Ethernet.  
...
The BS120x LabVIEW API package will install an example FIs under `<LabVIEW Examples\Bloomy\Battery Simulator 120x`. These examples demonstrate execution and configuration functionality.
